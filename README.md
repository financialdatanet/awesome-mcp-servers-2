...
- <img src="https://financialdata.net/static/images/favicon.ico" height="14"/> [FinancialData.Net](https://github.com/financialdatanet/mcp-server)<sup><sup>⭐</sup></sup> - Stock market data, company financial statements, key financial ratios and metrics, insider and institutional trading data, sustainability data, earnings releases, and much more.
